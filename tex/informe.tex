...
\section*{Implementación con Posix Threads}
    ...
    Usamos POSIX Messages Queues para la comunicación entre los distintos nodos. La misma forma un anillo entre los workers.\\ %pero puede cortarse en cualquier punto, para no ocuparlos innecesariamente con retransmisiones hasta llegar a completar la vuelta. 
    ...
    \item Reply: representa las respuestas del worker al handler. Contiene dos campos: uno representa errores al procesar un comando (Es de tipo Error. Si no hay errores es NONE.) y el otro sirve para agregar informacion extra sobre el resultado.
